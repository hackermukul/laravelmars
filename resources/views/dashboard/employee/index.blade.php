                     ...
                     <div class="float-right">
                       @if($user_access->add_module==1)	
                        ...
                        @endif
                         ...
                         <a href="{{ route($main_routes.'.setPositions') }}"> 
                              ...
                              <tr>
                                 ...
                                 <td>
                                    @if(!empty($row->roles))
                                       ...
                                       @endforeach
                                    @else
                                       {{ $row->roles[0]->user_role_name }}
                                    @endif
                                    </td>
                                 <td>@if(!empty($row->designation_name)){{$row->designation_name}} @else {{'N/A'}} @endif</td>
...
window.addEventListener('load' , function(){
	...
	$(".export_excel").bind("click" , function(){
		...
		$('#search_report_form').attr('action', '{{ route('employee.export-excel') }}');
