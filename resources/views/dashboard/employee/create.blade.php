                        ...
                        <div class="form-group row">
                              ...
                              <div class="col-sm-12">
                                 <select class="block mt-1 w-full select2" id="user_role_id" name="user_role_id[]" style="height:50px;" required  >
                                    <option value="">Please select</option>
                                       ...
                                       <option value="<?php echo $role_managers->id; ?>" @if (old("user_role_id")){{ (in_array($role_managers->id, old("user_role_id")) ? "selected":"") }}@endif >
                                          {{ $role_managers->name }}
                                    </option>
                                    <?php endforeach; ?>
                                 </select>
                              ...
                              <div class="col-sm-12">
                                 <select class="block mt-1 w-full select2" id="designation_id" name="designation_id" style="height:50px;" required >
                                    <option value="">Please select</option>
                                       ...
                                       <option value="<?php echo $designations->id; ?>" {{ old('designation_id') == $designations->id ? "selected" : "" }}>
                                          {{ $designations->name }}
                                    </option>
                                    <?php endforeach; ?>
                                 </select>
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-6">
                              <x-label for="Category" class="ccol-sm-12 label_content px-2 py-0" value="{{ __('Mobile No(*)') }}" />
                                 <div class="col-sm-12">
                                 <x-input id="mobile_no" class="block mt-1 w-full" type="number" name="mobile_no" :value="old('mobile_no')" required autofocus autocomplete="mobile_no" />
                                    <span>
                                       @error('mobile_no')
                                          <div class="error" style="color: red">{{ $errors }}</div>
                                       @enderror
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-6">
                              <x-label for="Category" class="ccol-sm-12 label_content px-2 py-0" value="{{ __('Joining Date(*)') }}" />
                                 <div class="col-sm-12">
                                 <x-input id="joining_date" class="block mt-1 w-full" type="date" name="joining_date" value="{{ old('joining_date', date('Y-m-d')) }}" required autofocus autocomplete="name" />
                                    <span>
                                       @error('joining_date')
                                          <div class="error" style="color: red">{{ $errors }}</div>
                                       @enderror
                                    ...
                                    <div class="form-check" style="margin-top:12px">
                                       <div class="form-group clearfix">
                                          <div class="icheck-success d-inline">
                                             <input type="radio" name="admin_access"  value="1" {{ old('admin_access') == '1' ? 'checked' : '' }} id="admin_access1">
                                             <label for="admin_access1"> Yes
                                             </label>
                                          </div>
                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          <div class="icheck-danger d-inline">
                                             <input type="radio" name="admin_access" value="0" {{ old('admin_access') == '1' ? 'checked' : 'checked' }} id="admin_access2">
                              ...
                              <x-label for="Category" class="ccol-sm-12 label_content px-2 py-0" value="{{ __('Approval Access') }}" />
                                 <div class="col-sm-12">
                                    <div class="form-check" style="margin-top:12px">
                                       <div class="form-group clearfix">
                                          <div class="icheck-success d-inline">
                                             <input type="radio" name="approval_access"  {{ old('approval_access') == '1' ? 'checked' : '' }} value="1" id="admin_access1">
                                             <label for="approval_access1"> Yes
                                             </label>
                                          </div>
                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          <div class="icheck-danger d-inline">
                                             <input type="radio" name="approval_access" {{ old('approval_access') == '1' ? 'checked' : 'checked' }} value="0" id="admin_access2">
                              ...
                              <x-label for="Category" class="ccol-sm-12 label_content px-2 py-0" value="{{ __('Data View') }}" />
                                 <div class="col-sm-12">
                                    <div class="form-check" style="margin-top:12px">
                                       <div class="form-group clearfix">
                                          <div class="icheck-success d-inline">
                                             <input type="radio" name="data_view"  value="1" {{ old('data_view') == '1' ? 'checked' : '' }} id="data_view1">
                                             <label for="data_view1"> Yes
                                             </label>
                                          </div>
                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          <div class="icheck-danger d-inline">
                                             <input type="radio" name="data_view" value="0" {{ old('data_view') == '0' ? 'checked' : 'checked' }} id="data_view1">
