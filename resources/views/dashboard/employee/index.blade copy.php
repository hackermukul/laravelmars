            ...
            <div id="accordion">
               ...
               <div class="card card-primary">
                  ...
                  <div id="collapseOne" class="panel-collapse collapse" style="">
                     <div class="card-body">                   
                        <form action="{{ route('categories.search') }}" method="post" id="search_report_form" name="search_report_form" style="" class="form-horizontal" role="form" accept-charset="utf-8">
                           @csrf
                             <div class="card-body">
                              <div class="row">
                                 <div class="col-md-2">
               ...
               <div class="card">
                  <div class="card-header">
                     ...
                     <div class="float-right">
                        ...
                        New</button></a>
                         <a href="{{ route('categories.setPositions') }}"> 
                            ...
                            @foreach ($categories as $row) @php($count++)
                              <tr>
                                 ...
                                 <td><input type="checkbox" name="sel_recds[]"
                                    id="sel_recds{{$count}}"
                                    value="{{$count}}" /></td>
                                 <td><a href="{{route('categories.show', ['id' => $row->id])}}">@if(!empty($row->name)){{$row->name}} @else {{'N/A'}} @endif </a></td>
