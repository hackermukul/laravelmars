      ...
      <div class="row">
         <div class="col-12">
            <div class="card">
               ...
               <!-- /.card-header -->
               <div class="card-body">
                    <form method="POST" action="{{ route('categories.store') }}"  id="ptype_list_form" name="ptype_list_form" style="" class="form-horizontal" role="form" enctype="multipart/form-data" accept-charset="utf-8">
                     @csrf
                     ...
                     <div class="">
                        <div class="form-group row">
                           ...
                           <div class="col-md-4 col-sm-6">
                              ...
                              <div class="col-sm-12">
                                <x-input id="content" class="block mt-1 w-full" type="text" name="content" :value="old('content')"  autofocus autocomplete="content" />
                                   <span>
                              ...
                              <div class="col-sm-12 d-flex">
                                 <div class="input-group" style="width:90%">
                                    <div class="custom-file">
                                       <input type="file" name="cover_image" class="custom-file-input" id="files" :value="old('image')" required="">
                                 ...
                                 <div class="custom-file-display">
                                    <span class="pip">
                                    <img class="imageThumb" style="height:43px;" src="{{ config('constants.options.MAINSITE').'build/assets/uploads/no-img.png' }}">
                                    </span>
                                 </div>
                              </div>
                           </div>
