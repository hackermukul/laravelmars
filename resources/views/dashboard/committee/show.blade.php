                        ...
                        <div class="table_col">
                         ...
                         <div class="table_col">
                           <label class="label_content_br">email <span class="colen">:</span></label>
                            @if($view_data[0]->email) {{ $view_data[0]->email}} @else {{'N/A'}} @endif                                   
                        </div>

                         <div class="table_col">
                           <label class="label_content_br">phone <span class="colen">:</span></label>
                            @if($view_data[0]->contact) {{ $view_data[0]->contact}} @else {{'N/A'}} @endif                                   
                        </div>

                        <div class="table_col">
                           <label class="label_content_br">designation <span class="colen">:</span></label>
                            @if($view_data[0]->designation) {{ $view_data[0]->designation}} @else {{'N/A'}} @endif                                   
                        </div>

                        <div class="table_col">
                           <label class="label_content_br">Related <span class="colen">:</span></label>
                            @if($view_data[0]->grievance_related_to) {{ $view_data[0]->grievance_related_to}} @else {{'N/A'}} @endif                                   
                        </div>
