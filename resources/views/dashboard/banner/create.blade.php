      ...
      <div class="row">
         <div class="col-12">
            <div class="card">
               ...
               <!-- /.card-header -->
               <div class="card-body">
                    <form method="POST" action="{{ route('banner_module.store') }}"  id="ptype_list_form" name="ptype_list_form" style="" class="form-horizontal" role="form" enctype="multipart/form-data" accept-charset="utf-8">
                     @csrf
                              ...
                              <div class="col-sm-12 d-flex">
                                 <div class="input-group" style="width:90%">
                                    <div class="custom-file">
                                       <input type="file" name="banner" class="custom-file-input" id="files" :value="old('banner')" required="">
