...
$filename = "data_listing-List-" . date('d-m-Y') . ".xls";
      ...
      <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
         <thead>
            ...
            <tr>
               ...
               <th style="background-color:#999">Grievance</th>
         ...
         <tbody>
            ...
            @foreach ($data_listing as $row)
               ...
               <tr>
                  ...
                  <td>{{ !empty($row->grievance) ? $row->grievance : 'N/A' }}</td>
                  <td>{{ !empty($row->realted_to) ? $row->realted_to : 'N/A' }}</td>
