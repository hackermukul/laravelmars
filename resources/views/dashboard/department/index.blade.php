<x-app-layout>
   ...
   <section class="content">
            ...
            <div id="accordion">
               ...
               <div class="card card-primary">
                  ...
                  <div id="collapseOne" class="panel-collapse collapse" style="">
                     <div class="card-body">                   
                        <form action="{{ route('department.search') }}" method="post" id="search_report_form" name="search_report_form" style="" class="form-horizontal" role="form" accept-charset="utf-8">
                           @csrf
                             <div class="card-body">
                              <div class="row">
                                 <div class="col-md-2">
                  ...
                  <div class="card-header">
                     ...
                     <div class="float-right">
                        ...
                        New</button></a>
                         ...
                         <a href="{{ route('department.setPositions') }}"> 
    ...
    <i class="fas fa-ban"></i> Delete
                  ...
                  <div class="card-body">
                     <form method="POST" action="{{ route('department.updateStatus') }}"  id="ptype_list_form" name="ptype_list_form" style="" class="form-horizontal" role="form" enctype="multipart/form-data" accept-charset="utf-8">
                     @csrf
                        ...
                        <table id="example1" class="table table-bordered table-hover table-striped">
                          ...
                          @if(!empty($department))
                           <tbody>
                           @php($count=0)
                            @foreach ($department as $row) @php($count++)
                              <tr>
                                 <td>{{$count}}</td>
                                 <td><input type="checkbox" name="sel_recds[]"
                                    id="sel_recds{{$count}}"
                                    value="{{$count}}" /></td>
                                 <td><a href="{{route('department.show', ['id' => $row->id])}}">@if(!empty($row->name)){{$row->name}} @else {{'N/A'}} @endif </a></td>
