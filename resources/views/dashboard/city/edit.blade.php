      ...
      <div class="row">
         <div class="col-12">
            <div class="card">
               ...
               <!-- /.card-header -->
               <div class="card-body">
                    <form method="POST" action="{{ route('city.update', $city->slug) }}"  id="ptype_list_form" name="ptype_list_form" style="" class="form-horizontal" role="form" enctype="multipart/form-data" accept-charset="utf-8">
                     @csrf
                       @method('PUT')
                    <input type="hidden" name="department_id"  value="{{ $city->id }}">
                     ...
                     <div class="">
                        <div class="form-group row">
                                 ...
                                 <select class="block mt-1 w-full select2" id="country_id" name="country_id" style="height:50px;" required onchange ="getState(this.value, 0)">
                                    <option value="">Please select</option>
                                       ...
                                       <option value="<?php echo $countryname->id; ?>"<?php
                                          if (isset($country_id) && Input::old('country_id') or $city->country_id == $countryname->id) 
                                          {
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-6">
                              ...
                              <div class="col-sm-12">
                                 <select class="block mt-1 w-full select2" id="state_id" name="state_id" style="height:50px;" required>
                                    <option value="">Please select</option>
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-6">
                            <x-label for="department" class="ccol-sm-12 label_content px-2 py-0" value="{{ __('Name(*)') }}" />
                              <div class="col-sm-12">
                                <x-input id="name" class="block mt-1 w-full" type="text" name="name" :value="$city->name" required autofocus autocomplete="name" />
                                 <span>
                                    @error('name')
                            ...
                            <x-label for="Category" class="ccol-sm-12 label_content px-2 py-0" value="{{ __('City Code') }}" />
                              <div class="col-sm-12">
                                <x-input id="city_code" class="block mt-1 w-full" type="text" name="city_code" :value="$city->city_code" autofocus autocomplete="name" />
                                 <span>
                                    @error('city_code')
                                        <div class="error" style="color: red">{{ $errors }}</div>
                                    @enderror
                                 ...
                                 <div class="form-check" style="">
                                    <div class="form-group clearfix">
                                       <div class="icheck-success d-inline">
                                          <input type="radio" name="status" value="1"  {{ old('status') == $city->status ? 'checked' : 'checked' }} id="Active" required="required" class="label-active">
                                          <label for="Active">{{ __('Active') }}</label>                                    
                                       </div>
                                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                       <div class="icheck-danger d-inline">
                                          <input type="radio" name="status" value="0" {{ old('status') == $city->status ? 'checked' : '' }} id="Block" required="required" class="label-block">
