...
<script>
   ...
   $(document).ready(function() {
    ...
    type: "POST",
   	url:'{{ route($main_routes.'.GetCompleteCountryList') }}',
      //dataType : "json",
         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('country.index') }}">@if($page_module_name != '' ) {{ $page_module_name; }} @else {{ 'NONE'}} @endif  List</a></li>
            ...
            <div class="box-body">
                  ...
                  <table class="table table-striped" id="table-2">
                     <thead>
                        <tr>
                           <th>Slno.</th>
                           <th>
                               <input type="checkbox" name="main_check" id="main_check" onclick="check_uncheck_All_records()" value="Checkbox" />
               ...
               <script>
                  ...
                  onDrop: function(table, row) {
                    ...
                    type: "POST",
                     url: '{{ route($main_routes.'.GetCompleteCategoryListNewPos') }}',
                     //dataType : "json",
