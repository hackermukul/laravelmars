...
<div class="container mt-5">
    <div class="card shadow">
        <div class="card-header text-center bg-white">
             <img src="https://via.placeholder.com/100/28a745/FFFFFF?text=Student" alt="Student" class="img-fluid rounded-circle mb-2" style="width: 80px;">
               ...
               <input type="hidden" name="registrations_type" value="student">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label for="course" class="form-label">Per Course & Major</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="semester" class="form-control @error('semester') is-invalid @enderror" value="{{ old('semester') }}" placeholder="Enter semester">
